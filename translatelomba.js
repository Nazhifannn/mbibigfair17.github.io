...
const translations = {
  id: {
    ...
    y0:'🥇 Medali',
    y1:'🏆 Piala',
    yuang01:'💵 Uang Pembinaan Rp2.500.000,00-',
    yuang0:'💵 Uang Pembinaan Rp2.000.000,00-',
    ...
    yuang6:'💵 Uang Pembinaan Rp250.000,00-',
    yuang7:'💵 Uang Pembinaan Rp150.000,00-',
    y3:'🎓 Sertifikat',
    y4:'🎁 Merchandise',
  ...
  en: {
    ...
    y0:'🥇 Trophy',
    y1:'🏆 Trophy',
    yuang01:'💵 Choaching Money Rp2.500.000,00-',
    yuang0:'💵 Choaching Money Rp2.000.000,00-',
    ...
    yuang6:'💵 Choaching Money Rp250.000,00-',
    yuang7:'💵 Choaching Money Rp150.000,00-',
    y3:'🎓 Sertificate',
    y4:'🎁 Merchandise',
    ...
    escimo2:'ESCIMO is one of the competitions in the 17th MBI BIG FAIR in the form of English speeches. This competition consists of 2 rounds, namely the preliminary and final rounds. ESCIMO tests the participants\' ability to deliver speeches in English with assessment criteria such as pronunciation, grammar, content, performance, and comprehension. Let\'s join the 17th MBI BIG FAIR and be the champion!',
    escimois:'What Is ESCIMO ?',
    barikna:'READ THE YELLOW BOOK',
    bariknais:'What Is BARIKNA ?',
    barikna2:'BARIKNA is one of the competition branches held in the MBI Big Fair 17 event in the form of Musabaqoh Qiroatul Kutub. This competition consists of 2 rounds, namely preliminary and final. The BARIKNA competition tests the participants\' ability to read the Matan Taqrib book according to the grammatical rules of the Arabic language (Nahwu and Shorof) as well as other aspects including reading accuracy, explanation, and fiqh development. Let\'s join MBI Big Fair 17 and be the champion!  ',
    mutaqina:'READING THE ISLAMIC SCRIPTURES',
    mutaqinais:'What Is MUTTAQINA ?',
    mutaqina2:'MUTTAQINA is one of the competitions in the 17th MBI BIG FAIR in the form of MTQ. This competition consists of 2 rounds, namely preliminary and final. MUTTAQINA tests the participants\' ability in reciting verses of the Quran with guidelines such as tone, fashohah, and tajwid. Let\'s join the 17th MBI BIG FAIR and be the champion!',
    qorona:'ARABIC SINGING',
    qoronais:'What Is QORONA ?',
    qorona2:'QORONA is one of the competitions in the 17th MBI BIG FAIR in the form of singing in Arabic. This competition consists of 2 rounds, namely preliminary and final. QORONA tests the participants\' ability to sing in Arabic with assessment criteria such as pronunciation, melody, and expression. Let\'s join the 17th MBI BIG FAIR and be the champion!',
    fesban:'BANJARI FESTIVAL',
    fesbanis:'What Is FESBAN ?',
    fesban2:'FESBAN is one of the competitions in MBI BIG FAIR 17. This competition consists of one round. FESBAN tests the participants\' proficiency in singing sholawat accompanied by banjari music according to the assessment criteria of vocals, banjari music, manners and lyrics, as well as jingle songs. Join MBI BIG FAIR 17 and be the champion!',
